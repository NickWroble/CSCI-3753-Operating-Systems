...
#define MAXPROCPAGES 10 	/* max pages per individual process */ 
#define MAXPROCESSES 20 	/* max number of processes in runqueue */ 
#define PAGESIZE 256 		/* size of an individual page */ 
#define PAGEWAIT 100 		/* wait for paging in */ 
#define PHYSICALPAGES 50	/* number of available physical pages */ 
